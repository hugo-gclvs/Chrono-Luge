...
void loop () {
  ...
  Serial.print("<ID00><BE>05<E><ID00><L1><PA><FE><MA><WC><FE><CD>bonjour10<E><ID00><BF>06<E>");                      //<L1> Décris la ligne du message, <PA> la page, <FA> le sens du message ? <MA> les paramètres d'affichage, <WC> la durée du message  <FE>"message"<FE>
