...
void loop() {
  ...
  //Serial.write("<ID00><BE><05><E>"); // trame de début

  //trame pour l'affichage du message "Hello"
  Serial1.write("<ID00><L1><PA><FE><MA><WC><FE>Hello36<E>"); // envoi de la première partie de la trame (code non variant utile à la configuration de l'affichage
 // Serial1.write("Hello"); // envoi du texte à afficher
  //Serial1.write("36"); //valeur du checksum
  //Serial1.write("<E>");

  //trame pour l'affichage du message "oui"
 /* Serial.write("<ID00><L1><PA><FE><MA><WC><FE><CA"); // envoi de la première partie de la trame (code non variant utile à la configuration de l'affichage
  Serial.write("oui"); // envoi du texte à afficher
